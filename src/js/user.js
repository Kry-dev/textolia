...
//    $('.menu-navbar .nav-item .nav-link').each(function () {
//        var location = window.location.href;
//        var link = this.href;
//        if (location == link) {
//            $('.menu-navbar .nav-item').addClass('active');
//        }
//    });
//
//});
...
jQuery(function ($) {
    ...
    var dials = $(".dial");
    // Перебираем все .dial и вставляем туда canvas с графиком.
    for (i = 0; i < dials.length; i++) {
        ...
        $(dials[i]).html('<canvas id="dial' + i + '" width="' + size + '" height="' + size + '"></canvas><p>' + procent +' </p><span class="dial_span--block"></span>');
